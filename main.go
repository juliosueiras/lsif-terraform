...
// Original Source: https://github.com/sourcegraph/lsif-go/blob/master/cmd/lsif-go/main.go
package main
...
import (
	...
	"github.com/juliosueiras/lsif-terraform/index"
...
func realMain() error {
	...
	app := kingpin.New("lsif-terraform", "lsif-terraform is an LSIF indexer for Terraform. Adapted from lsif-go").Version(versionString)
